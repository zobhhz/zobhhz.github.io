    ...
    return (
        <section className="w-full bg-coral-50">
            <div className="flex flex-col items-start justify-center p-10 sm:p-20 space-y-10 max-w-7xl mx-auto">
                ...
                {/* DETAILS */}
                <div className={`text-coral-950 grid grid-cols-1 sm:grid-cols-2 ${colClass} gap-4`}>
                    {details.map((detail => (
                    ...
                    <div className="flex flex-row space-x-4">
                        {links.map((link) => (
                            <a
                                ...
                                className="px-4 py-2 bg-coral-400 text-white rounded text-center inline-block hover:scale-105 transition-all duration-150"
                            >
                                {link.label}
                            </a>
                        ))}
