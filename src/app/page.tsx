      ...
      <main className="flex flex-col md:flex-row gap-8 items-center justify-center">
        ...
        <div className="flex gap-4 items-center md:items-start flex-col">
          ...
          <p className="text-justify text-lg lg:text-2xl">
            I&apos;m a <a className="hover:text-coral-400 hover:underline hover:underline-offset-4" href="https://www.dlsu.edu.ph/">
          ...
          <a
            ...
            className="align-center px-4 py-2 bg-coral-400 text-white rounded text-center inline-block hover:scale-105 transition-all duration-150"
          >
            View Resume
          </a>
        </div>
