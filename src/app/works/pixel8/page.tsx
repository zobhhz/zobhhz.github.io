...
export default function Page() {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 sm:p-20 space-y-10 md:space-y-20 max-w-7xl mx-auto">
            <h1 className="font-bold text-2xl lg:text-4xl">Pixel8 Web Consultancy & Solutions Inc.</h1>
            {/* DETAILS */}
            ...
            <div className="space-y-4 w-full">
                ...
                <div className="place-self-center relative w-full max-w-3xl aspect-video border border-gray-300 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                    <Image
            ...
            <div className="space-y-4 w-full">
                ...
                <div className="place-self-center relative w-full max-w-48 aspect-[9/20] border border-gray-300 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                    <Image
